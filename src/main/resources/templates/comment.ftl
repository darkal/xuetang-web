...
<html class="no-js" lang="en">
    ...
    <body>
                                ...
                                <li class="item">
                                    <div class="item-row">
                                        ...
                                        <div class="item-col fixed item-col-img md">
                                            <a href="">
                                                <div class="item-img rounded" style="background-image: url(${item.avatar})"></div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="item-col fixed pull-left item-col-title">
                                            <div class="item-heading">评论内容</div>
                                            <div>
                                                <a href="" class="">
                                        ...
                                        <div class="item-col item-col-category no-overflow">
                                            <div class="item-heading">所属视频</div>
                                            <div class="no-overflow">
                                                <a href="content.do?id=${item.videoId}" target="_blank">${item.videoId}</a>
                                            </div>
                                        </div>
                                        <div class="item-col item-col-sales">
                                            <div class="item-heading">是否置顶</div>
                                            <div> ${item.top?c} </div>
                                        </div>
                                        ...
                                        <div class="item-col item-col-date">
                                            ...
                                            <div class="no-overflow">${item.time?number_to_datetime} </div>
                                        </div>
                ...
                <div class="modal fade" id="confirm-modal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="deleteItem()">Yes</button>
        ...
        <script>
            function deleteItem(){
                $.get("deleteComment.do?id="+$('#deleteid').val());
            }
        </script>
